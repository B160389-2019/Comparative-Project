...
sizeGrWindow(12,9)
#pdf(file = "/Users/yaoyuelin/Desktop/AdiposeClustering.pdf", width = 12, height = 9);
par(cex = 0.6);
par(mar = c(0,4,2,0))
...
sizeGrWindow(8,6)
tiff(file = "/Users/yaoyuelin/Desktop/muscle_net111.tiff",##reqiured to change
...
dev.off()
tiff(file = "/Users/yaoyuelin/Desktop/muscle_net222.tiff",##reqiured to change
     res = 300, width = 1200, height = 1200,compression = "lzw")
...
tiff(file = "/Users/yaoyuelin/Desktop/muscle_net3.tiff",##reqiured to change
...
tiff(file = "/Users/yaoyuelin/Desktop/cattle-clustering-muscle.tiff",##reqiured to change
...
tiff(file = "/Users/yaoyuelin/Desktop/human-clustering-muscle.tiff",##reqiured to change
     res = 300, width = 600, height = 600,compression = "lzw")
...
length(modProbes)
write.table(modProbes,"/Users/yaoyuelin/Desktop/green.txt",append = F,quote = F,sep = "/t",row.names = F,col.names = F)
...
ego_BP <- enrichGO(gene = gene$ENTREZID,
                   ...
                   readable = TRUE)
(ego_BP[,1:6])
write.csv(ego_BP,'/Users/yaoyuelin/Desktop/muscle-green-all-human.csv',row.names = F)
...
modProbes = probe[inModule]
length(modProbes)
write.table(modProbes,"/Users/yaoyuelin/Desktop/blue.txt",append = F,quote = F,sep = "/t",row.names = F,col.names = F)
gene<- bitr(modProbes, fromType="ENSEMBL", toType = c("SYMBOL", "ENTREZID"), OrgDb=org.Hs.eg.db, drop = T)
ego_BP <- enrichGO(gene = gene$ENTREZID,
                   OrgDb= org.Hs.eg.db,
                   ont = "BP",
                   ...
                   readable = TRUE)
(ego_BP[,1:6])
write.csv(ego_BP,'/Users/yaoyuelin/Desktop/muscle-blue-all-human.csv',row.names = F)
...
modProbes = probe[inModule]
length(modProbes)
write.table(modProbes,"/Users/yaoyuelin/Desktop/black.txt",append = F,quote = F,sep = "/t",row.names = F,col.names = F)
gene<- bitr(modProbes, fromType="ENSEMBL", toType = c("SYMBOL", "ENTREZID"), OrgDb=org.Hs.eg.db, drop = T)
ego_BP <- enrichGO(gene = gene$ENTREZID,
                   OrgDb= org.Hs.eg.db,
                   ont = "BP",
                   ...
                   readable = TRUE)
(ego_BP[,1:6])
write.csv(ego_BP,'/Users/yaoyuelin/Desktop/muscle-black-all-human.csv',row.names = F)
...
modProbes = probe[inModule]
length(modProbes)
write.table(modProbes,"/Users/yaoyuelin/Desktop/brown.txt",append = F,quote = F,sep = "/t",row.names = F,col.names = F)
gene<- bitr(modProbes, fromType="ENSEMBL", toType = c("SYMBOL", "ENTREZID"), OrgDb=org.Hs.eg.db, drop = T)
ego_BP <- enrichGO(gene = gene$ENTREZID,
                   OrgDb= org.Hs.eg.db,
                   ont = "BP",
                   ...
                   readable = TRUE)
(ego_BP[,1:6])
write.csv(ego_BP,'/Users/yaoyuelin/Desktop/muscle-brown-all-human.csv',row.names = F)
############3
#######
...
modProbes = probe[inModule]
length(modProbes)
write.table(modProbes,"/Users/yaoyuelin/Desktop/pink.txt",append = F,quote = F,sep = "/t",row.names = F,col.names = F)
gene<- bitr(modProbes, fromType="ENSEMBL", toType = c("SYMBOL", "ENTREZID"), OrgDb=org.Hs.eg.db, drop = T)
ego_BP <- enrichGO(gene = gene$ENTREZID,
                   OrgDb= org.Hs.eg.db,
                   ont = "BP",
                   ...
                   readable = TRUE)
(ego_BP[,1:6])
write.csv(ego_BP,'/Users/yaoyuelin/Desktop/muscle-pink-all-human.csv',row.names = F)
...
modProbes = probe[inModule]
length(modProbes)
write.table(modProbes,"/Users/yaoyuelin/Desktop/red.txt",append = F,quote = F,sep = "/t",row.names = F,col.names = F)
gene<- bitr(modProbes, fromType="ENSEMBL", toType = c("SYMBOL", "ENTREZID"), OrgDb=org.Hs.eg.db, drop = T)
ego_BP <- enrichGO(gene = gene$ENTREZID,
                   OrgDb= org.Hs.eg.db,
                   ont = "BP",
                   ...
                   readable = TRUE)
(ego_BP[,1:6])
write.csv(ego_BP,'/Users/yaoyuelin/Desktop/muscle-red-all-human.csv',row.names = F)
...
modProbes = probe[inModule]
length(modProbes)
write.table(modProbes,"/Users/yaoyuelin/Desktop/turquoise.txt",append = F,quote = F,sep = "/t",row.names = F,col.names = F)
gene<- bitr(modProbes, fromType="ENSEMBL", toType = c("SYMBOL", "ENTREZID"), OrgDb=org.Hs.eg.db, drop = T)
ego_BP <- enrichGO(gene = gene$ENTREZID,
                   OrgDb= org.Hs.eg.db,
                   ont = "BP",
                   ...
                   readable = TRUE)
(ego_BP[,1:6])
write.csv(ego_BP,'/Users/yaoyuelin/Desktop/muscle-turquoise-all-human.csv',row.names = F)
########
module="yellow"
inModule = (dynamicColors==module);
modProbes = probe[inModule]
length(modProbes)
write.table(modProbes,"/Users/yaoyuelin/Desktop/yellow.txt",append = F,quote = F,sep = "/t",row.names = F,col.names = F)
gene<- bitr(modProbes, fromType="ENSEMBL", toType = c("SYMBOL", "ENTREZID"), OrgDb=org.Hs.eg.db, drop = T)
ego_BP <- enrichGO(gene = gene$ENTREZID,
                   OrgDb= org.Hs.eg.db,
                   ont = "BP",
                   ...
                   readable = TRUE)
(ego_BP[,1:6])
write.csv(ego_BP,'/Users/yaoyuelin/Desktop/muscle-yellow-all-human.csv',row.names = F)
...
tiff("/Users/yaoyuelin/Desktop/correlation.tiff",res = 300, width = 1600, height = 1300,compression = "lzw")
...
a$estimate
tiff(file = "/Users/yaoyuelin/Desktop/black.tiff",##reqiured to change
...
a<-cor.test(Connectivity_human,Connectivity_cattle,method = "s",use = "p")
a$estimate
tiff(file = "/Users/yaoyuelin/Desktop/blue.tiff",##reqiured to change
     res = 300, width = 1500, height = 1500,compression = "lzw")
...
a<-cor.test(Connectivity_human,Connectivity_cattle,method = "s",use = "p")
a$estimate
tiff(file = "/Users/yaoyuelin/Desktop/brown.tiff",##reqiured to change
     res = 300, width = 1500, height = 1500,compression = "lzw")
...
a<-cor.test(Connectivity_human,Connectivity_cattle,method = "s",use = "p")
a$estimate
tiff(file = "/Users/yaoyuelin/Desktop/green.tiff",##reqiured to change
     res = 300, width = 1500, height = 1500,compression = "lzw")
...
a<-cor.test(Connectivity_human,Connectivity_cattle,method = "s",use = "p")
a$estimate
tiff(file = "/Users/yaoyuelin/Desktop/grey.tiff",##reqiured to change
     res = 300, width = 1500, height = 1500,compression = "lzw")
...
a<-cor.test(Connectivity_human,Connectivity_cattle,method = "s",use = "p")
a$estimate
tiff(file = "/Users/yaoyuelin/Desktop/pink.tiff",##reqiured to change
     res = 300, width = 1500, height = 1500,compression = "lzw")
...
a<-cor.test(Connectivity_human,Connectivity_cattle,method = "s",use = "p")
a$estimate
tiff(file = "/Users/yaoyuelin/Desktop/red.tiff",##reqiured to change
     res = 300, width = 1500, height = 1500,compression = "lzw")
...
a<-cor.test(Connectivity_human,Connectivity_cattle,method = "s",use = "p")
a$estimate
tiff(file = "/Users/yaoyuelin/Desktop/turquoise.tiff",##reqiured to change
     res = 300, width = 1500, height = 1500,compression = "lzw")
...
a<-cor.test(Connectivity_human,Connectivity_cattle,method = "s",use = "p")
a$estimate
tiff(file = "/Users/yaoyuelin/Desktop/yellow.tiff",##reqiured to change
     res = 300, width = 1500, height = 1500,compression = "lzw")
