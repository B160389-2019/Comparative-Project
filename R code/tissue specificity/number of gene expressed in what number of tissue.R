...
tiff(file="/Users/yaoyuelin/Desktop/gene_pc_human.tiff", width = 8, height = 7, units = "cm", res = 600, pointsize = 8,compression= "lzw")
...
tissue_pc_mean_count
tissue_pc_mean_count_human
table(Orthologous_human_cattle$`Gene stable ID`==rownames(tissue_pc_mean_count_human))
table(Orthologous_human_cattle$`Cow gene stable ID`==rownames(tissue_pc_mean_count))

rownames(tissue_pc_mean_count_human)<-rownames(tissue_pc_mean_count)

cor.test(tissue_pc_mean_count_human,tissue_pc_mean_count_human,method = "spearman")
