...
logFC_cutoff=1.5
human_file<-dir("/Users/yaoyuelin/Downloads/desktop/Comparative/tissue_specific_limma/human",full.names = T)
human_file
humantissue<-substr(human_file,nchar("/Users/yaoyuelin/Downloads/desktop/Comparative/tissue_specific_limma/human/myresults_")+1,nchar(human_file)-nchar("_human.txt"))
humantissue

cattle_file<-dir("/Users/yaoyuelin/Downloads/desktop/Comparative/tissue_specific_limma/cattle",full.names = T)
cattle_file
cattletissue<-substr(cattle_file,nchar("/Users/yaoyuelin/Downloads/desktop/Comparative/tissue_specific_limma/cattle/myresults_")+1,nchar(cattle_file)-nchar(".txt"))
cattletissue
i=1
for( i in 18:20){
  ...
  ego_BP_human <- enrichGO(gene = gene_human$ENTREZID,
                     ...
                     qvalueCutoff = 0.05,
                     readable = TRUE)
  write.xlsx(ego_BP_cattle,file=paste0("/Users/yaoyuelin/Desktop/species_specific_tissue_specific genes/cattle-specific/cattle_",cattletissue[i],".xlsx"),showNA=TRUE)
  write.xlsx(ego_BP_human,file=paste0("/Users/yaoyuelin/Desktop/species_specific_tissue_specific genes/human-specific/human_",humantissue[i],".xlsx"),showNA=TRUE)
}
