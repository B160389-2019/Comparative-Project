...
tissue_list
human_file<-dir("/Users/yaoyuelin/Desktop/tissue_specific_limma/human",full.names = T)
cattle_file<-dir("/Users/yaoyuelin/Desktop/tissue_specific_limma/cattle",full.names = T)
human_file
humantissue<-substr(human_file,nchar("/Users/yaoyuelin/Desktop/tissue_specific_limma/human/myresults_")+1,nchar(human_file)-nchar("_human.txt"))
humantissue
tissue_list
cattle_file
cattletissue<-substr(cattle_file,nchar("/Users/yaoyuelin/Desktop/tissue_specific_limma/cattle/myresults_")+1,nchar(cattle_file)-nchar(".txt"))
cattletissue
...
for(i in 1:length(human_file)){
  ...
  ego_BP <- enrichGO(gene = gene$ENTREZID,
                     ...
                     qvalueCutoff = 0.05,
                     readable = TRUE)
  write.xlsx(ego_BP,file=paste0("/Users/yaoyuelin/Desktop/Tissue-specific enrichment/overlap/",tissue_list[i],".xlsx"))
