...
a<-phyper(overlap$Overlap-1 , overlap$Human, 17315-overlap$Human , overlap$Cattle,lower.tail= FALSE)

Mydata_raw_FDR <- p.adjust(a,method = "BH")
...
###########
overlap<-read_xlsx("/Users/yaoyuelin/Desktop/table/overlap.xlsx",sheet = NULL, range = NULL, col_names = T,
                   col_types = NULL, na = "", trim_ws = TRUE, skip = 0)

overlap<-as.data.frame(overlap,row.names = NULL)
overlap
rownames(overlap)<-unique(sort(experiment$tissue_new))
overlap
...
tiff(file = "/Users/yaoyuelin/Desktop/tissue_specific_gene_number.tiff",##reqiured to change
...
a<-cor.test(as.numeric(median["Adrenal - Human",]),as.numeric(median["Adrenal - Cattle",]))
...
tiff("/Users/yaoyuelin/Desktop/correlation_all_genes_barplot.tiff",res = 300, width = 2200, height = 1500,compression = "lzw")
...
#save(overlap,overlap_t,file="overlap.Rdata")
overlap_t
...
tiff("/Users/yaoyuelin/Desktop/correlation-tissuegenenumber.tiff",res = 300, width = 2000, height = 2000,compression = "lzw")
...
tiff("/Users/yaoyuelin/Desktop/correlation-Overlap_Percentage.tiff",res = 300, width = 800, height = 800,compression = "lzw")
...
library(ggpubr)
tiff("/Users/yaoyuelin/Desktop/tissue_specific_correlation_spearman.tiff",res = 300, width = 700, height = 700,compression = "lzw")
...
cor.test(overlap$Cattle,overlap$Human)
