...
write.table(up_human_tissue,file=paste0("/Users/yaoyuelin/Desktop/species_specific/up_human_",tissue[i],".txt"),append = F,quote = F,sep = "/t",row.names = F,col.names = F)
write.table(up_cattle_tissue,file=paste0("/Users/yaoyuelin/Desktop/species_specific/up_cattle_",tissue[i],".txt"),append = F,quote = F,sep = "/t",row.names = F,col.names = F)
